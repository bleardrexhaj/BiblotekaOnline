@extends('layouts.app')
@section('page-header')
    @includeIf('partials.page-title_search',['tittle'=>'Nenkategoria'])
@endsection
@section('content')
        ...
        <div class="col-md-10 ">
            <div class="row mb-3">
                <div class="col-md-12 pb-3">
                    ...
                    <h2 class="font-weight-bold m-0 p-0">{{$subcategory->name}}</h2>
                </div>
                <div class="col-md-3">

                    <p class="small text-uppercase text-muted mb-0">Numri i librave:</p>
                    <p class="font-weight-bold mt-0">{{$subcategory->numberOfBooks}}</p>

                </div>
                <div class="col-md-3">

                    <p class="small text-uppercase text-muted mb-0">Kategoria prind:</p>
                    <p class="font-weight-bold mt-0">{{$subcategory->category->name}}</p>
                ...
                <div class="col-md-6 align-self-center">
                    @isset($subcategory->description)
                        ...
                        <p class="mt-0">{{$subcategory->description}}</p>
