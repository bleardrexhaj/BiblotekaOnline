...
@section('content')
    ...
    <div class="card mb-3">
        <div class="card-header">
            Ndryshe te dhenat e librit "{{$book->title}}"
        </div>
            ...
            <form action="/book/{{$book->id}}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        <input type="text" value="{{$book->title}}" name="title" class="form-control" id="title" required>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <select id="categories" name="categories[]" class="form-control form-control-chosen" data-placeholder="Zgjidh kategorite" multiple>
                            ...
                            @foreach(\App\Category::all() as $category)
                                <option @if($book->categories->contains($category))
                                        selected
                                        @endif
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="number" value="{{$book->stock}}" name="stock" class="form-control" id="stock" required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" value="@isset($book->isbns[0]){{$book->isbns[0]->isbn}}@endisset" name="isbn" class="form-control" id="isbn" placeholder="ISBN">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" value="@isset($book->isbns[0]){{$book->isbns[0]->isbn}}@endisset" name="issn" class="form-control" id="issn" placeholder="ISSN">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" value="{{$book->pub_year}}" name="pub_year" class="form-control" id="pub_year" required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <select id="language" name="language" class="form-control form-control-chosen">
                            ...
                            @foreach(\App\Language::all() as $language)
                                <option
                                        @if($book->language->id == $publisher->id)
                                        selected
                                        @endif
                    ...
                    <div class="form-group col-md-1">
                        <a href="#AddLanguageModal" class="btn btn-link" id="addLanguage" data-toggle="modal" data-target="#AddLanguageModal"><i class="fa fa-plus-circle"></i></a>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        <input type="text" value="{{$book->properties}}" name="properties" class="form-control" id="properties">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        <div class="form-control">
                            ...
                            <img id="blah" class="img-thumbnail my-3" src="{{asset('storage/book_covers/'.$book->cover_path)}}" alt="Foto e kopertines" />
                        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Shto Shtepine Botuese</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
...
<!--Language Modal-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Shto Gjuhen e Librit</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="form" method="POST" action="/language" onsubmit="return checkForm(this);">
        {{csrf_field()}}
          <div class="form-group">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary" name="submit_btn" id="submit_btn" onclick="">Save changes</button>
        </form>
      </div>
    </div>
  </div>
