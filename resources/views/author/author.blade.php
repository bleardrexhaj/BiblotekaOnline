@extends('layouts.app')
@section('page-header')
    @includeIf('partials.page-title_search',['tittle'=>'Autori'])
@endsection
@section('content')
        ...
        <div class="col-md-10 ">
            <div class="row mb-3">
                <div class="col-md-12 pb-3">
                    ...
                    <h2 class="font-weight-bold m-0 p-0">{{$author->name}}</h2>
                </div>
                <div class="col-md-3">

                    <p class="small text-uppercase text-muted mb-0">Numri i librave:</p>
                    <p class="font-weight-bold mt-0">{{$author->numberOfBooks}}</p>

                </div>
                <div class="col-md-9 align-self-center">
                    @isset($author->bio)

                        <p class="small text-uppercase  text-muted mb-0">Biografia:  </p>
                        <p class="mt-0">{{$author->bio}}</p>
